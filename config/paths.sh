...
# Директории zapret
export ZAPRET_DIR="/opt/zapret2"
export ZAPRET_CONFIG_DIR="/opt/zapret2/config"
export ZAPRET_IPSET_DIR="/opt/zapret2/ipset"
export ZAPRET_FAKE_DIR="/opt/zapret2/files/fake"
export ZAPRET_CUSTOM_DIR="/opt/zapret2/init.d/custom.d"

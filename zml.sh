...
menu_hosts() {
    while true; do
        ...
        echo " 0) $(hosts_group_label nalog)  nalog.ru"
        echo " 1) $(hosts_group_label rutor)  rutor.info"
        echo " 2) $(hosts_group_label ntc)  ntc.party"
        echo " 3) $(hosts_group_label instagram)  Instagram & Facebook"
        echo " 4) $(hosts_group_label librusec)  lib.rus.ec"
        echo " 5) $(hosts_group_label ai)  AI сервисы"
        echo " 6) $(hosts_group_label twitch)  Twitch"
        echo " 7) $(hosts_group_label telegram)  Telegram Web"
        echo " 8) $(hosts_group_label spotify)  Spotify"
        echo " 9) $(hosts_group_label supercell)  Supercell"
        echo "10) $(hosts_group_label github)  githubusercontent.com"
